		...
		<div class="col-lg-6" style="margin-top:20px">
			<div class="card shadow">
				<div class="card-body">
					...
					<table class="table table-hover" id='board_list'>
						...
						<tbody>
							...
							<tr>
								...
								<th><a href='${root }board/read?content_idx=${obj.content_idx}&board_info_idx=${board_list[idx.index].board_info_idx}'>
					...
					<a href="${root}board/main?board_info_idx=${board_list[idx.index].board_info_idx}"
