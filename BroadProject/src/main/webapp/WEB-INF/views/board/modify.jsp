               ...
               <form:form action="${root }board/modify_pro" modelAttribute="modifyContentBean" method="post" enctype="multipart/form-data">
                 ...
                 <form:hidden path="content_board_idx"/>
                  ...
                  <div class="form-group">
                     ...
                     <form:input path="content_writer_name" class="form-control" value="${modify.content_writer_name}" readonly="true"/>
                  </div>
                  <div class="form-group">
                     <form:label path="content_date">작성날짜</form:label>
                     <form:input path="content_date" class="form-control" value="${modify.content_date}" readonly="true"/>
                  </div>
                  <div class="form-group">
                     <form:label path="content_subject">제목</form:label>
                     <form:input path="content_subject" class="form-control" value="${modify.content_subject}"/>
                 	<form:errors path="content_subject" style = "color:red;" />
                  </div>
                  <div class="form-group">
                     <form:label path="content_text">내용</form:label>
                     <form:textarea path="content_text" class="form-control" rows="10" value="${modify.content_text}" style="resize:none" />
